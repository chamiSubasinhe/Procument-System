...
public class PaymentsControllerTest extends ProcurementUtils {
	...
	public void retrieveAllPaymentData_Test() throws Exception {
		...
		mvc.perform(get("/payment").contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk())
	...
	public void savePaymentData_Test() throws Exception {
		mvc.perform(post("/payment").content(PAYMENT_REQUEST).contentType(APPLICATION_JSON_UTF8))
	...
	public void updatePaymentData_Test() throws Exception {
		String payId = "ST1022";
		MockHttpServletRequestBuilder builder = MockMvcRequestBuilders.put("/payment/" + payId)
